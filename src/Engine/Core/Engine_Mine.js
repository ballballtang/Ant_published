...
gEngine.Mine = (function () {
    ...
    var getVariable = function (){
        gEngine.Mine.v = document.getElementById("velocity").value;
        
        for(var i = 1; i <=5; i ++){
            gEngine.Mine.position[i-1] = document.getElementById("location"+i).value -290;
        }

        for(var i = 1; i <=5; i ++){
            gEngine.Mine.velocity[i-1] = document.getElementById("direction"+i).value * gEngine.Mine.v;
        }
    };
